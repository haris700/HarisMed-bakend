...
const CORE_FIELDS = [
  ...
  { key: 'urineDipstickProtein', label: 'Urine Protein (Routine)',   unit: 'Grade',  placeholder: 'e.g. 2+, 1+, Nil' },
  { key: 'totalProtein',         label: 'Total Protein (Serum)',     unit: 'g/dL',   placeholder: 'e.g. 4.67' },
  { key: 'albumin',              label: 'Albumin (Serum)',           unit: 'g/dL',   placeholder: 'e.g. 3.40' },
  { key: 'globulin',             label: 'Globulin (Serum)',          unit: 'g/dL',   placeholder: 'e.g. 1.27' },
  { key: 'agRatio',              label: 'A/G Ratio',                 unit: '',       placeholder: 'e.g. 2.68' },
